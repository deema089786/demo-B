...
export const RouteFromIcon = (props: SvgIconProps) => (
  <SvgIcon {...props}>
    <svg
    ...
    >
      <path
        d="M5.77778 16C4.66596 16.6327 4 17.4385 4 18.3158C4 20.3505 7.58172 22 12 22C16.4183 22 20 20.3505 20 18.3158C20 17.4385 19.334 16.6327 18.2222 16"
        stroke="currentColor"
        stroke-width="1.5"
